...
export default function Login() {
  ...
  // ✅ FUNCIÓN DE LOGIN SIMPLIFICADA Y CORREGIDA
  const handleLogin = async () => {
    ...
    try {
      ...
      // ✅ Usar la función login del AuthProvider (simplificado)
          ...
          {process.env.NODE_ENV !== 'production' && (
            ...
            >
              ...
              <div style={{ marginTop: '8px', fontSize: '10px', color: colors.textMuted }}>
                <strong>Nota:</strong> Usando endpoint único /api/login con campo "pass"
              </div>
            </div>
          )}
        </div>
